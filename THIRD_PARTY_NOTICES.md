...
|---|---|---|---|
| Dati qualità dell'aria (sensori, stazioni) | `data/arpa-pv-*.json` (rielaborati: aggregazione giornaliera) | [IODL 2.0](https://www.dati.gov.it/iodl/2.0/) | ARPA Lombardia, via [Regione Lombardia Open Data](https://www.dati.lombardia.it) |
...
media mobile su 8 ore), come richiesto dalla licenza IODL 2.0 in caso di modifica. Le elaborazioni non sono statistiche ufficiali ARPA.
